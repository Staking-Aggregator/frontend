      ...
      <div className="providers-container">
        ...
        <div className="providers">
          ...
          <AppCard key={index} styles={{ backgroundColor: "#1d1e1f"}}>
            ...
            <CardContent sx={{padding:0, ':last-child':{padding:0},display:'flex',flexDirection:'column',gap:'0.7rem'}}>
              <div>
              <h3>{provider.providerName}</h3>
              <p className="token-symbol">{provider.tokenSymbol}</p>
              </div>
            ...
            <CardActions disableSpacing sx={{display:'flex',justifyContent:'center',gap:'1rem'}}>
              <AppButton styles={{backgroundColor:'rgba(255, 63, 109, 0.1)',color:'rgba(255,0,61,1)'}}>Stake</AppButton>
              <AppButton styles={{backgroundColor:'rgba(238,238,238,0.1)'}}>Learn More</AppButton>
            </CardActions>
          </AppCard>
          ))}
        </div>
